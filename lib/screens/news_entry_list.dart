...
import 'package:football_news/screens/news_details.dart';
...
class _NewsEntryListPageState extends State<NewsEntryListPage> {
  Future<List<NewsEntry>> fetchNews(CookieRequest request) async {
    ...
    // For Chrome: http://localhost:8000/json/
    // For Android Emulator: http://10.0.2.2:8000/json/
    // For Physical Device: http://<YOUR_PC_IP>:8000/json/
            ...
            if (!snapshot.hasData) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (_, index) => NewsEntryCard(
                  ...
                  onTap: () {
                    // Navigate to the NewsDetailPage for this item
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) =>
